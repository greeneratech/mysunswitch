          ...
          <v-card class="rounded-lg pb-7">
            ...
            <v-form style="max-width: 900px; margin: auto; padding: 30px">
              ...
              <v-btn
                ...
                @click="createDisclaimer"
                class="rounded-lg white--text mt-5"
                block
                x-large
                color="#199958"
                ><v-icon class="mr-5">mdi-plus</v-icon>Create Disclaimer</v-btn
              >
            </v-form>
          </v-card>
        </v-col>
...
export default {
  ...
  methods: {
    createDisclaimer() {
      ...
      axios({
        method: "POST",
        url: "https://greeneratech.herokuapp.com/api/admin/disclaimers/create",
        data: {
          title: this.title,
        ...
        this.$swal({
          title: "Success!",
          text: "Disclaimer created successfully",
          type: "success",
