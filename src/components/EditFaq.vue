    ...
    <v-app>
      ...
      <v-col lg=8 md=8 class="mx-auto">
          <v-card class="rounded-lg pb-7">
              ...
              <h2 style="color:white;background:#006838;padding:10px">Edit Faq</h2>
               <v-form style="max-width:900px;margin:auto;padding:30px">
                  ...
                  <v-btn :loading="faqloading" @click="editFAQ" class="rounded-lg white--text mt-5" block x-large color="#199958"><v-icon class="mr-5">mdi-pen</v-icon>Edit FAQ</v-btn>
...
export default {
    ...
    methods:{
        editFAQ(){
            ...
            axios({
                method:"PUT",
                url:"https://greeneratech.herokuapp.com/api/admin/faqs/update/"+this.singleFaq.id,
                data:{
                    question:this.singleFaq.question,
                    answer:this.singleFaq.answer,
                    title:this.singleFaq.question,
                    description:this.singleFaq.answer
                },
                headers:{
