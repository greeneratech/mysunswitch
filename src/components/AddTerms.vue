          ...
          <v-card class="rounded-lg pb-7">
              ...
              <h2 style="color:white;background:#006838;padding:10px">New Terms and Conditions</h2>
               <v-form style="max-width:900px;margin:auto;padding:30px">
                  ...
                  <v-btn :loading="termloading" @click="createTerm" class="rounded-lg white--text mt-5" block x-large color="#199958"><v-icon class="mr-5">mdi-plus</v-icon>{{title}}</v-btn>
